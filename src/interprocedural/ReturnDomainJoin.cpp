...
public:
  ...
  void visitReturnInst(llvm::ReturnInst &I) {
    ...
    auto current = state->second.findAbstractValueOrBottom(I.getReturnValue());
...
joinReturnDomain(std::map<BasicBlock *, State> const &program_points) {
